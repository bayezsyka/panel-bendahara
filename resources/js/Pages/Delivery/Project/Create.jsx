...
export default function Create({ customers, concreteGrades, selectedCustomerId }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('delivery.projects.store'));
    };

    return (
        <BendaharaLayout>
            <Head title="Buat Proyek Pengiriman Baru" />

            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    <Link 
                        href={data.customer_id ? route('delivery.customers.show', data.customer_id) : route('delivery.projects.index')}
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">Buat Proyek Baru</h2>
                    <p className="text-sm text-gray-500 mt-1">Daftarkan proyek baru untuk pengiriman beton</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div className="flex justify-end gap-3 pt-6">
                        <SecondaryButton as={Link} href={route('delivery.projects.index')} disabled={processing}>Batal</SecondaryButton>
