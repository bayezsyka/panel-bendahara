            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-6">
                        <SecondaryButton as={Link} href={data.delivery_project_id ? route('delivery.projects.show', data.delivery_project_id) : route('delivery.projects.index')} disabled={processing}>Batal</SecondaryButton>
