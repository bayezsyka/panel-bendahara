...
import { DataTable, Badge, Select, Card } from '@/Components/ui';
            ...
            render: (row) => (
                <div>
                    ...
                    <div className="text-xs text-gray-400 mt-1">
                        {row.type === 'in' ? (row.cash_source?.name || 'Internal Transfer/Lainnya') : (row.cash_expense_type?.name || 'Biaya Lain')}
                    </div>
                </div>
            ),
        },
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2">
                        <PageHeader
                            title="Kas Kecil"
                            subtitle="Kelola pemasukan dan pengeluaran kas kecil."
