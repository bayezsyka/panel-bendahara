...
import { ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, FileText, Calendar, Download, Plus } from 'lucide-react';
    ...
    return (
        <BendaharaLayout>
            ...
            <div className="space-y-6 pb-20">
                ...
                <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            <h3 className="text-lg font-medium text-purple-100">Sisa Saldo Akhir Hari Ini</h3>
                            <p className="text-sm text-purple-200 mt-1">Saldo Awal + Pemasukan - Pengeluaran</p>
                        </div>
                        <div className="text-right">
