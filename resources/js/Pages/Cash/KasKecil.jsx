...
export default function KasKecil({ transactions, cashSources, cashExpenseTypes, totalIn, totalOut, balance, filters }) {
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 space-y-2">
                        <div className="flex items-center gap-2">
                            <Link href={route('kas.dashboard')} className="text-gray-500 hover:text-purple-600">
                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                                </svg>
                            </Link>
                            <h2 className="text-2xl font-bold text-gray-900">Kas Kecil</h2>
                        </div>
                        <p className="text-gray-500">Kelola pemasukan dan pengeluaran kas kecil.</p>
                    </div>
                    ...
                    <div className="bg-purple-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                         ...
                         <div className="relative z-10">
                            <p className="text-purple-100 text-sm font-medium uppercase tracking-wider mb-1">Saldo Saat Ini</p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <div className="flex gap-3">
                        {/* Pemasukan Kas Kecil hanya dari Transfer Kas Besar */}
                        <PrimaryButton onClick={() => openModal('out')} className="bg-red-600 hover:bg-red-700 focus:ring-red-500">
                            - Pengeluaran
                        </PrimaryButton>
                    </div>
