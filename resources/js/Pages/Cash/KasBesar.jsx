...
import { ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, FileText, Calendar, Download, Plus, ArrowRightLeft, Search, Filter, X } from 'lucide-react';
...
export default function KasBesar({ 
    ...
    useEffect(() => {
        ...
        searchTimeout.current = setTimeout(() => {
            ...
            router.get(route('kas.kas-besar'), params, {
                preserveScroll: true,
                preserveState: true,
                replace: true,
            });
                                                ...
                                                <tr key={item.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                                                    <td className="px-6 py-4">
                                                        <div className="flex flex-col">
                                                            ...
                                                            {searchQuery && (
                                                                <span className="text-[10px] text-indigo-500 font-bold uppercase mt-1">
                                                                    {new Date(item.transaction_date).toLocaleDateString('id-ID', { weekday: 'short', day: '2-digit', month: 'short' })}
                                                                </span>
                                                            )}
                                                        </div>
                                                    </td>
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleTransferSubmit} className="space-y-4">
                        <div>
                            ...
                            <TextInput type="date" className="w-full mt-1" value={transferData.transaction_date} onChange={e => setTransferData('transaction_date', e.target.value)} required max={new Date().toISOString().split('T')[0]} />
