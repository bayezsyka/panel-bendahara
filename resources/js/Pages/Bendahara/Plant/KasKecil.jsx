...
export default function KasKecil({ transactions, expenseTypes, totalIn, totalOut, balance, filters }) {
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Pencatatan arus kas kecil kantor plant</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                placeholder="Contoh: Uang Jajan / Fotokopi"
                                required
                            />
