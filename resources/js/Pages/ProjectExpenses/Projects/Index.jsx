...
export default function Index({ projects, mandors, benderas }) {
    ...
    const { can_edit: can_manage_projects } = auth.permissions || {};
    ...
    const deleteProject = (id) => {
        Swal.fire({
            title: 'Hapus Proyek?',
            text: 'Proyek ini akan dipindahkan ke keranjang sampah.',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                router.delete(route('projectexpense.projects.destroy', id), {
                    preserveScroll: true,
                });
            }
        });
                ...
                <PageHeader
                    ...
                    actions={
                        <div className="flex items-center gap-3">
                            {can_manage_projects && (
                                <Link
                                    href={route('projectexpense.projects.trash')}
                                    className="p-2.5 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all group"
                                    title="Tempat Sampah"
                                >
                                ...
                                <div className="bg-gray-50 px-5 py-3 border-t border-gray-100 flex justify-between items-center">
                                    ...
                                    {can_manage_projects && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button
                                                onClick={(e) => { e.preventDefault(); deleteProject(project.slug || project.id); }}
