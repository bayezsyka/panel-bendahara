...
export default function EmptyState({
    ...
    return (
        <div className={`flex flex-col items-center justify-center text-center ${compact ? 'py-8' : 'py-16 px-6'}`}>
            <div className="w-16 h-16 bg-gray-50 dark:bg-[#1a1a2e] rounded-2xl flex items-center justify-center mb-4">
                {icon || (
                    <svg className="w-8 h-8 text-gray-200 dark:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
