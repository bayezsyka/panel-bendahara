                    ...
                    <div className="flex-1 overflow-y-auto px-3 py-4 custom-scrollbar space-y-1">
                        ...
                        {activePanel === 'delivery' && (
                            <>
                                ...
                                <SidebarLink 
                                    name="Mobil Molen" 
                                    routeName="delivery.trucks.index" 
                                    icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9a1 1 0 01-1-1m4 0h1m-1 0a1 1 0 011 1v1a1 1 0 001 1h1a1 1 0 001-1v-1a1 1 0 011-1h1a1 1 0 001-1V8a1 1 0 00-1-1h-2a1 1 0 00-1 1v-1.5m4 1.5v3h-3v-3h3z" /></svg>}
                                />
                                <SidebarLink 
