        ...
        <div className="h-screen bg-gray-50 flex overflow-hidden">
            ...
            >
                ...
                <div className="flex items-center h-20 px-4 border-b border-gray-100 overflow-hidden whitespace-nowrap">
                    <Link href={route(activePanel === 'finance' ? 'projectexpense.overview' : (activePanel === 'kas' ? 'kas.dashboard' : (activePanel === 'delivery' ? 'delivery.projects.index' : 'receivable.index')))} className="flex items-center gap-3">
